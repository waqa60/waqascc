...
def login():
	os.system('clear')
	print logo
	print "\033[1;91m[1]\033[1;47m\033[1;35mLogin With Facebook"
        time.sleep(0.05)
        print "\033[1;92m[2]\033[1;47m\033[1;35mLogin With Token"
        time.sleep(0.05)
        print "\033[1;93m[3]\033[1;47m\033[1;35mDownload Token App"
        time.sleep(0.05)
	pilih_login()
...
def login1():
	...
	try:
		...
		os.system('clear')
                time.sleep(0.05)
		print logo                
		print "\033[1;95m•-----------------\033[1;37mWAQAS\033[1;97m-----------------•"
		print('\033[1;91m[+]\033[1;47m\033[1;31mLOGIN WITH FACEBOOK\x1b[1;97m \033[1;0m' )
		print('	' )
		id = raw_input('\033[1;92m[!] \x1b[1;97mNumber/Email')
		pwd = raw_input('\033[1;93m[+] \x1b[1;97mPassword')
		tik()
		try:
